            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  At GoChess, our vision is to democratize access to quality chess education. We believe that chess is not just a game but a powerful tool for developing critical thinking, strategic planning, and mental discipline.
                </p>
